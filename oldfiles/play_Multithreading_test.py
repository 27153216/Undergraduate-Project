...
def resetGame():
    # 宣告使用全域變數.
    global game_mode, brick_num, bricks_list, dx, dy, brick_quantity, Collision
...
# 顯示Title.
pygame.display.set_caption(u"臉部表情運動及老態預防--單人闖關")
# 建立畫佈大小.
...
window = win32gui.FindWindow(None ,u'臉部表情運動及老態預防--單人闖關') #找到遊戲主視窗
...
#        paddle_x = 0
    ...
    #顯示磚塊數量.
    showFont( u"磚塊數量:"+str(brick_num),   8, 38)            
