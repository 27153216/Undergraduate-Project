...
def detect():
    ...
    for i in indices:
        ...
        if emotion== "neutral":
            ...
            returnx = 10
        elif (emotion == "happy" and game_mode == 0 and xxx > Width/2) or (emotion == "happy" and game_mode == 2 and xxx < Width/2):
            ballSound.play()
            if dx < 0:
                dx = -dx
            game_mode = 1
            returnx = 0
        elif (emotion == "surprised" and game_mode == 0 and xxx > Width/2) or (emotion == "surprised" and game_mode == 2 and xxx < Width/2):
            ballSound.play()
            if dx > 0:
                dx = -dx
            game_mode = 1
